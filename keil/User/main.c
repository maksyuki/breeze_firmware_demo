...
//    }
    ...
    //Motor_SetPWM(800, 800, 800, 800);
        
//    while(1)
//    {
//        Motor_SetPWM(100, 0, 0, 0);
//        LED_A_ON;
//        Delay_TimeMs(2000);
//        LED_A_OFF;
//        Motor_SetPWM(0, 100, 0, 0);
//        LED_B_ON;
//        Delay_TimeMs(2000);
//        LED_B_OFF;
//        Motor_SetPWM(0, 0, 100, 0);
//        LED_C_ON;
//        Delay_TimeMs(2000);
//        LED_C_OFF;
//        Motor_SetPWM(0, 0, 0, 100);
//        LED_D_ON;
//        Delay_TimeMs(2000);
//        LED_D_OFF;
//    }
    ...
    while (1)
    {
        ...
        if (timer_loop_flag_100hz)
        {
            ...
            //======TEST======START
//            printf("roll: %.8f pitch: %.8f yaw: %.8f \r\n", IMU_TableStructure.roll_ang,
//                              IMU_TableStructure.pitch_ang, IMU_TableStructure.yaw_ang);
            //======TEST======END
